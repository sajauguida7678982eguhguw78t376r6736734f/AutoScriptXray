...
LLatest=`date`
Get_Data () {
git clone https://github.com/givpn/backup.git /root/user-backup/ &> /dev/null
}
...
Save_And_Exit () {
    cd /root/user-backup
    git config --global user.email "givpn11@gmail.com" &> /dev/null
    git config --global user.name "givpn" &> /dev/null
    rm -fr .git &> /dev/null
    git init &> /dev/null
    git add . &> /dev/null
    git commit -m m &> /dev/null
    git branch -M main &> /dev/null
    git remote add origin https://github.com/givpn/backup
    git push -f https://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@github.com/givpn/backup.git &> /dev/null
}
...
link="https://raw.githubusercontent.com/givpn/backup/master/$NameUser/$NameUser.zip"
sleep 1
...
cekdata=$(curl -sS https://raw.githubusercontent.com/givpn/backup/master/$NameUser/$NameUser.zip | grep 404 | awk '{print $1}' | cut -d: -f1)
...
mkdir /root/backup
wget -q -O /root/backup/backup.zip "https://raw.githubusercontent.com/givpn/backup/master/$NameUser/$NameUser.zip" &> /dev/null
