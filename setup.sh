...
echo ""
wget -q https://raw.githubusercontent.com/givpn/AutoScriptXray/master/tools.sh;chmod +x tools.sh;./tools.sh
rm tools.sh
clear
...
clear
#install ohp
wget https://raw.githubusercontent.com/givpn/AutoScriptXray/master/xolpanel.sh && chmod +x xolpanel.sh && ./xolpanel.sh
clear
cat> /root/.profile << END
# ~/.profile: executed by Bourne-compatible login shells.
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/givpn/AutoScriptXray/master/version  )
