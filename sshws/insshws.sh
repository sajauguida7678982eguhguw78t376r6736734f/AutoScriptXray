...
#wget -O /usr/local/bin/ws-openssh https://raw.githubusercontent.com/givpn/AutoScriptXray/master/sshws/openssh-socket.py
wget -O /usr/local/bin/ws-dropbear https://raw.githubusercontent.com/givpn/AutoScriptXray/master/sshws/dropbear-ws.py
